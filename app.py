...
def main():
    ...
    # cap_device = "test_video/test_gun.mp4"
    # cap_device = "test_video/test_gun_walking.mp4"
    # cap_device = "test_video/finger_walking_test1.mp4"
    ...
    print("width height : "+str(cap_width)+', ' +str(cap_height))

    info_elements["screensize"] = str(cap_width)+','+str(cap_height)
